---
layout: post
title: "Life Is an Infinite Game"
author: boyu
date: 2026-06-03 22:00:00 +0800
categories: [ Journal, Philosophy ]
tags: [ infinite-game, mindset, philosophy, writing, life ]
description: "Finite games are played to win. Infinite games are played to keep playing. A reflection on why staying in the game matters more than any single score — including why I wrote this post after a long pause."
mermaid: true
image: /assets/images/headers/life-infinite-game.jpg
---
...
```mermaid
graph TD
    Moment["<b>A Setback or Pause</b><br/><i>Something interrupts the rhythm</i>"]

    Moment --> Finite["<b>Finite Mindset</b><br/><i>&quot;I lost. It's over.&quot;</i>"]
    Moment --> Infinite["<b>Infinite Mindset</b><br/><i>&quot;The game continues.&quot;</i>"]

    Finite --> Quit["<b>Quit</b><br/><i>Protect the scoreboard</i>"]
    Infinite --> Return["<b>Return</b><br/><i>Play the next move</i>"]

    Quit --> Gone["<b>Out of the Game</b><br/><i>(done)</i>"]
    Return --> Loop["<b>Still Playing</b>"]
    Loop -.->|next challenge, next season| Moment

    classDef trigger fill:#fff,stroke:#906,stroke-width:3px,color:#000;
    classDef finite fill:#fff,stroke:#c62828,stroke-width:2px,color:#000;
    classDef infinite fill:#fff,stroke:#0277bd,stroke-width:2px,color:#000;
    classDef quit fill:#fff,stroke:#c62828,stroke-width:2px,stroke-dasharray: 5 5,color:#000;
    classDef loop fill:#fff,stroke:#2e7d32,stroke-width:2px,color:#000;

    class Moment trigger;
    class Finite,Quit finite;
    class Infinite,Return infinite;
    class Gone quit;
    class Loop loop;
```
