...
```mermaid
graph TD
    Input["<b>Input</b><br/><i>Small, repeatable action</i>"]
    Store["<b>Store</b><br/><i>What accumulates</i>"]
    Return["<b>Return</b><br/><i>Output that helps next round</i>"]
    Reinvest["<b>Reinvest</b><br/><i>Feed return back in</i>"]
    ...
    classDef node fill:#fff,stroke:#0277bd,stroke-width:2px,color:#000;
    classDef loop fill:#fff,stroke:#906,stroke-width:2px,stroke-dasharray: 5 5,color:#000;

    class Input,Store,Return node;
    class Reinvest loop;
```
